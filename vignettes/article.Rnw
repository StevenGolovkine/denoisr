...
library(tidyverse)
source('http://bit.ly/ggcustom_theme')
@
...
%
<<manualpackage, eval=FALSE>>=
help(package="SmoothCurves")
@
%
...
%
<<data_frac_brownian>>=
data("fractional_brownian", package = "SmoothCurves")
@
%
...
%
<<smooth_data>>=
smooth_data <- smooth.curves(fractional_brownian)
smooth_data$parameter
@
%
...
%
<<plot_res_brownian>>=
df <- tibble(t = fractional_brownian[[1]]$t,
