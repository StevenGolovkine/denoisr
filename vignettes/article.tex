...
employing some simulated datasets and the canonical dataset of the daily 
temperature of $35$ canadian cities.

From within \proglang{R}, the latest version of \pkg{SmoothCurves} can be 
installed from the Comprehensive \proloang{R} Archive Network (CRAN) 
