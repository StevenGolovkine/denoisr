...
To install the latest version directly from [Github](https://github.com/StevenGolovkine/denoisr), please use
```{r, eval=FALSE}
...
The `denoisr` package depends on the `R`-packages [`doParallel`](https://CRAN.R-project.org/package=doParallel), [`dplyr`](https://CRAN.R-project.org/package=dplyr),
...
Please use [GitHub issues](https://github.com/StevenGolovkine/denoisr/issues) for reporting bugs or issues.